...
**Tech stack:** Next.js frontend on Vercel, Flask backend on Railway, Stripe payments, Claude API for resume parsing + cover letter generation, Scrapling-powered web discovery (with BS4 fallback), PostgreSQL, and live API integration with 6 regional Greenhouse/Lever endpoints.
